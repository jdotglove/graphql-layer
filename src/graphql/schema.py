...
from .queries import get_one_album, get_one_artist, get_one_playlist, get_one_track, get_one_user, get_many_albums, get_many_artists, get_many_tracks, get_many_users
...
class Query:
    ...
    getManyAlbums: List[Album] = strawberry.field(resolver=get_many_albums)
    getManyArtists: List[Artist] = strawberry.field(resolver=get_many_artists)
    getManyPlaylists: List[Playlist] = strawberry.field(resolver=get_many_playlists)
    getManyTracks: List[Track] = strawberry.field(resolver=get_many_tracks)
    getManyUsers: List[User] = strawberry.field(resolver=get_many_users)
